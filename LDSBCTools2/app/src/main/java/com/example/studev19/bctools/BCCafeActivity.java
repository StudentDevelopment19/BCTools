...
/**
 * Created by alejandrolopez on 4/26/16.
 */
public class BCCafeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bccafe);                                                   //Layout and views come from activity_feedback.xml
        ...
        final String bccafeURL = previousActivity.getStringExtra("bccafe");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_bccafe, menu);
        return true;
    }
