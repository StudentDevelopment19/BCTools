...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[][] contactInfo = {
                {"Academic Advising",           "Meet with an academic advisor for academic guidance in planning, scheduling, and readiness to graduate.",                                                          "801-524-8152", "advising@ldsbc.edu*",      "Room 905",     "Monday-Friday 9am-5pm"},
                ...
                {"Campus Visits",               "Discover if the LDS Business College experience is right for you. Let us share with you opportunities and resources that have been designed for your success.",    "801-524-8159", "campusvisit@ldsbc.edu",    "Second Floor", "Monday-Friday 9am-5pm"},
                ...
                {"Honor Code",                  "Contact the Honor Code Office for inquiries or reporting concerns about conduct, Honor Code policies, and ecclesiastical endorsements.",                           "801-524-8157", "hc@ldsbc.edu",             "Room 905",     "Monday-Friday 9am-5pm"},
                {"Housing",                     "Learn how and where to find housing close to campus.",                                                                                                             "801-524-8180", "house@ldsbc.edu",          "Room 905",     "Monday-Friday 9am-5pm"},
